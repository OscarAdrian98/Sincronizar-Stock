            ...
            for configuracion_proveedor in configuraciones_proveedor:
                if len(configuracion_proveedor) >= 5:
                    ...
                    if archivo_bytes is not None:
                        ...
                        # Sin embargo, para mantener tu solicitud de impresión, creamos un df_filtrado idéntico a df_referencias_stock
                        ...
                        #print("DATAFRAME FINAL: ", df_filtrado)
                        ...
                        with tqdm(total=df_filtrado.shape[0], desc="Actualizando etiquetas") as pbar:
                            ...
                            deactivate_attributes(conexion_prestashop, df_filtrado, batch_size=5000)
                            # FUNCION PARA DESACTIVAR/ACTIVAR ATTRIBUTES DE SUPPLIER
                            #update_id_shop_in_attribute_shop_supplier(conexion_prestashop, df_filtrado, batch_size=5000)
                    else:
